...
public class Tester {
	...
	private static void trySolver(State initialState, AbstractSolver solver) throws IOException {
	...
	private static void trySolvers(State initialState) throws IOException {
